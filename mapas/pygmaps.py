...
class maps:
	...
	def script_drawradpoints(self, f):
 	...
 	def script_drawmap(self):
		...
		f.append('\t\t\tzoom: %d,\n' % (self.zoom))
		f.append('\t\t\tcenter: centerlatlng,\n')
		f.append('\t\t\tmapTypeId: google.maps.MapTypeId.ROADMAP\n')
		f.append('\t\t};\n')
		f.append('\t\tvar map = new google.maps.Map(document.getElementById(\"map_canvas\"), myOptions);\n')
		f.append('\n')
		f=''.join(f)
		return f
	...
	def script_drawpoint(self,f,lat,lon,color):
		...
		f.append('\t\tvar marker = new google.maps.Marker({\n')
		f.append('\t\ttitle: "no implimentation",\n')
		f.append('\t\ticon: img,\n')
		f.append('\t\tposition: latlng\n')
		f.append('\t\t});\n')
		f.append('\t\tmarker.setMap(map);\n')
		f.append('\n')
		f=''.join(f)
		return f
